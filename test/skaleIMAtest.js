...
const MAINNET_ENDPOINT = 'http://127.0.0.1:8545';
const SCHAIN_ENDPOINT = 'http://127.0.0.1:15000';
...
contract("SkaleIMA", async (accounts) => {
  it("skale deposit eth test", async () => {
    console.log('using network',config.network)
    console.log(await config.networks[config.network].provider())
