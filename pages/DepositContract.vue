...
export default {
  ...
  async mounted() {
    ...
    if (localStorage.DepositrecipientAddress) this.recipientAddress = localStorage.DepositrecipientAddress
    if (localStorage.DepositcontractFactoryAddress) this.contractFactoryAddress = localStorage.DepositcontractFactoryAddress
    if (localStorage.Depositminted) this.minted = localStorage.Depositminted
  ...
  methods: {
    ...
    async launchToken(){
      ...
      this.minted = localStorage.Depositminted = true
      this.amount = 100
    },
    async sendToken(){
